    ...
    return (
        ...
        <section className="py-12 md:py-24 border-t border-zinc-200 dark:border-zinc-700 fade-in" style={{ animationDelay: '0.4s' }}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 md:gap-8">
                ...
                <Link className="group flex flex-col h-full p-5 sm:p-6 md:p-8 rounded-3xl bg-zinc-50 dark:bg-zinc-900/50/50 hover:bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 transition-all duration-300" to="/services/content-creation">
                ...
                <Link className="group flex flex-col h-full p-5 sm:p-6 md:p-8 rounded-3xl bg-zinc-50 dark:bg-zinc-900/50/50 hover:bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 transition-all duration-300" to="/services/web-development">
                    <div className="relative w-full aspect-video rounded-2xl overflow-hidden mb-6 sm:mb-8 bg-zinc-200 border border-zinc-200 dark:border-zinc-700/50">
                ...
                <Link className="group flex flex-col h-full p-5 sm:p-6 md:p-8 rounded-3xl bg-zinc-50 dark:bg-zinc-900/50/50 hover:bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 transition-all duration-300" to="/services/ai-automation">
                    <div className="relative w-full aspect-video rounded-2xl overflow-hidden mb-6 sm:mb-8 bg-zinc-200 border border-zinc-200 dark:border-zinc-700/50">
                ...
                <Link className="group flex flex-col h-full p-5 sm:p-6 md:p-8 rounded-3xl bg-zinc-50 dark:bg-zinc-900/50/50 hover:bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 transition-all duration-300" to="/services/branding-growth">
                    <div className="relative w-full aspect-video rounded-2xl overflow-hidden mb-6 sm:mb-8 bg-zinc-200 border border-zinc-200 dark:border-zinc-700/50">
        ...
        <section className="pt-16 md:pt-32 pb-8 md:pb-16 text-center fade-in" style={{ animationDelay: '0.6s' }}>
            ...
            <Link className="inline-flex items-center justify-center px-6 sm:px-8 py-3.5 sm:py-4 text-sm font-medium tracking-wide text-white bg-black rounded-full hover:bg-zinc-800 transition-colors duration-300 shadow-lg shadow-black/20 group w-full sm:w-auto max-w-[280px] mx-auto" to="/services/contact">
                Work With Us
