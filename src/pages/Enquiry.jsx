                ...
                {formStatus !== 'success' ? (
                    ...
                    <div className="bg-white dark:bg-black rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-gray-200 dark:border-gray-800 p-10 text-center fade-in">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link to="/" className="w-full sm:w-auto px-8 py-3.5 rounded-xl text-sm font-bold text-black dark:text-white bg-white dark:bg-black border border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:bg-black/50 dark:hover:bg-gray-900 transition-all shadow-sm">
                                Back to Home
                            </Link>
