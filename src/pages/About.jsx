    ...
    return (
        <main className="min-h-screen relative bg-transparent text-gray-900 dark:text-gray-100 overflow-x-hidden pt-20 pb-20 fade-in">
            ...
            <div className="pt-8 pb-4 px-4 relative max-w-7xl mx-auto flex items-center justify-center mt-8 md:mt-12">
                <button onClick={() => navigate(-1)} className="absolute left-4 sm:left-8 p-2 rounded-full bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm hover:bg-white/80 dark:hover:bg-gray-800/80 border border-white/60 dark:border-gray-700 shadow-sm transition-all group cursor-pointer" title="Go Back">
