            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12">
                ...
                <div className="md:col-span-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
                        ...
                        {/* Card 1 */}
                        <Link className="group block rounded-xl md:rounded-2xl bg-white dark:bg-black border border-zinc-200 dark:border-zinc-700 overflow-hidden hover:border-zinc-300 dark:border-zinc-600 hover:shadow-2xl hover:shadow-zinc-200/50 transition-all duration-500" to="/services/ai-automation/ai-agents">
                        ...
                        {/* Card 2 */}
                        <Link className="group block rounded-xl md:rounded-2xl bg-white dark:bg-black border border-zinc-200 dark:border-zinc-700 overflow-hidden hover:border-zinc-300 dark:border-zinc-600 hover:shadow-2xl hover:shadow-zinc-200/50 transition-all duration-500" to="/services/ai-automation/automation-services">
                            <div className="aspect-video w-full bg-zinc-100 dark:bg-zinc-800 relative overflow-hidden">
                                <div className="absolute inset-0 flex items-center justify-center text-zinc-400 text-[10px] md:text-xs font-medium z-0">
