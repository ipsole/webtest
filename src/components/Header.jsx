  ...
  return (
    <header className="fixed top-4 z-50 w-full px-4 sm:px-6 lg:px-8 flex flex-col items-center pointer-events-none transition-all duration-300">
        ...
        <div className="flex justify-between items-center w-full gap-4 xl:gap-8">
          ...
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 flex-shrink-0">
            <div className="hidden xl:flex items-center space-x-1">
              <Link to="/" className="flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-black dark:text-white dark:hover:text-white hover:bg-gray-100 dark:bg-gray-800/80 dark:hover:bg-gray-800/80 px-4 py-2 rounded-full transition-all duration-200">
                Home
              </Link>
              <a href="https://portfolio.docdril.com" className="flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-black dark:text-white dark:hover:text-white hover:bg-gray-100 dark:bg-gray-800/80 dark:hover:bg-gray-800/80 px-4 py-2 rounded-full transition-all duration-200">
                Portfolio
              </a>
              <Link to="/about" className="flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-black dark:text-white dark:hover:text-white hover:bg-gray-100 dark:bg-gray-800/80 dark:hover:bg-gray-800/80 px-4 py-2 rounded-full transition-all duration-200">
                About
              </Link>
              <Link to="/services" className="flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-black dark:text-white dark:hover:text-white hover:bg-gray-100 dark:bg-gray-800/80 dark:hover:bg-gray-800/80 px-4 py-2 rounded-full transition-all duration-200">
                Services
              </Link>
              <Link to="/policy" className="flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-black dark:text-white dark:hover:text-white hover:bg-gray-100 dark:bg-gray-800/80 dark:hover:bg-gray-800/80 px-4 py-2 rounded-full transition-all duration-200">
                Policy
              </Link>
              
              <a href="https://os.docdril.com" className="flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-black dark:text-white dark:hover:text-white hover:bg-gray-100 dark:bg-gray-800/80 dark:hover:bg-gray-800/80 px-4 py-2 rounded-full transition-all duration-200">
                <Smartphone className="w-4 h-4" />
                App
              </a>

              <Link to="/contact" className="ml-2 text-sm font-bold text-gray-900 dark:text-white py-2 px-5 border border-gray-200 dark:border-gray-800 rounded-full bg-white dark:bg-black hover:bg-gray-50 dark:bg-gray-900/50 dark:hover:bg-gray-900 active:scale-95 transition-all duration-200 shadow-sm hover:shadow-md">
                Contact
              </Link>
            </div>
            
            <Link to="/enquiry" className="flex items-center justify-center w-9 h-9 md:w-10 md:h-10 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-full shadow-lg hover:shadow-xl transition-transform transform hover:scale-110 active:scale-95 group flex-shrink-0" title="Enquiry">
      ...
      <div className={`xl:hidden w-full max-w-7xl mt-2 bg-white/95 dark:bg-black/95 backdrop-blur-xl rounded-2xl border border-white/60 dark:border-gray-800/60 shadow-xl pointer-events-auto flex-col space-y-2 px-4 py-6 transition-all duration-300 ${isMobileMenuOpen ? 'flex' : 'hidden'}`}>
        <Link to="/" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-900 dark:text-white font-medium hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-800 transition-all duration-200">
          Home
        </Link>
        ...
        <Link to="/about" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-900 dark:text-white font-medium hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-800 transition-all duration-200">
          About
        </Link>
        <Link to="/services" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-900 dark:text-white font-medium hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-800 transition-all duration-200">
          Services
        </Link>
        <Link to="/policy" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-900 dark:text-white font-medium hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-800 transition-all duration-200">
          Policy
        </Link>
