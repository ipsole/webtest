...
export default function Home() {
  ...
  return (
        ...
        >
            ...
            <section className="w-full pt-2 pb-2 sm:pb-3 px-4 sm:px-6 lg:px-8 overflow-hidden relative z-20">
                <div className="text-center">
                    ...
                    <div className="header-slide-in w-full relative flex flex-col items-center justify-center mt-6 sm:mt-8 mb-0" style={{ animationDelay: '0.7s' }}>
                        ...
                        {/* SVG Tree Flow — animated orthogonal paths with rounded corners */}
                        <div className="w-full flex flex-col items-center mt-0 z-0" aria-hidden="true">
                            <svg
                                viewBox="0 0 1000 130"
                                className="w-full max-w-5xl text-gray-300 dark:text-zinc-700"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                style={{ overflow: 'visible' }}
                            >
                                {/* Static Background Paths */}
                                <path d="M500,0 L500,40" stroke="currentColor" strokeWidth="2"/>
                                <path d="M500,40 Q500,70 470,70 L175,70 Q145,70 145,100 L145,130" stroke="currentColor" strokeWidth="2"/>
                                <path d="M500,40 L500,130" stroke="currentColor" strokeWidth="2"/>
                                <path d="M500,40 Q500,70 530,70 L825,70 Q855,70 855,100 L855,130" stroke="currentColor" strokeWidth="2"/>
                                {/* Animated Data Flow Dots */}
                                <circle r="3" fill="currentColor" className="text-gray-500 dark:text-zinc-400">
                                    <animateMotion dur="2.5s" repeatCount="indefinite" calcMode="linear">
                                        <mpath xlinkHref="#path-left"/>
                                    </animateMotion>
                                </circle>
                                <circle r="3" fill="currentColor" className="text-gray-500 dark:text-zinc-400">
                                    <animateMotion dur="2.5s" repeatCount="indefinite" calcMode="linear" begin="0.8s">
                                        <mpath xlinkHref="#path-center"/>
                                    </animateMotion>
                                </circle>
                                <circle r="3" fill="currentColor" className="text-gray-500 dark:text-zinc-400">
                                    <animateMotion dur="2.5s" repeatCount="indefinite" calcMode="linear" begin="1.6s">
                                        <mpath xlinkHref="#path-right"/>
                                    </animateMotion>
                                </circle>
                                {/* Named paths for animateMotion */}
                                <defs>
                                    <path id="path-left"  d="M500,0 L500,40 Q500,70 470,70 L175,70 Q145,70 145,100 L145,130"/>
                                    <path id="path-center" d="M500,0 L500,130"/>
                                    <path id="path-right" d="M500,0 L500,40 Q500,70 530,70 L825,70 Q855,70 855,100 L855,130"/>
                                </defs>
                            </svg>
                        </div>
            ...
            <section id="services" className="w-full bg-transparent flowing-section flow-top relative z-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 !pt-2 sm:!pt-2">
                    <div className="text-center mb-12 md:mb-20 mt-0 relative z-20">
                        <div className="reveal-on-scroll inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 mb-5">
                            <span className="relative flex h-2 w-2"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span><span className="relative inline-flex rounded-full h-2 w-2 bg-blue-500"></span></span>
                            <span className="text-xs font-bold text-blue-700 dark:text-blue-300 uppercase tracking-widest">Premium Capabilities</span>
                        </div>
                        <h2 className="reveal-on-scroll text-3xl sm:text-4xl md:text-6xl font-extrabold tracking-tight">
                            <span className="text-gray-900 dark:text-white">Our Service </span>
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">Menu</span>
                        </h2>
                        <p className="reveal-on-scroll mt-4 text-sm sm:text-lg text-gray-500 dark:text-gray-400 font-medium max-w-2xl mx-auto">Everything you need to scale your brand and digital presence — from one studio.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
                        ...
                        <Link href="/services/content-creation" className="h-full reveal-on-scroll block group" style={{ transitionDelay: '0.0s' }}>
                        ...
                        <Link href="/services/ai-automation" className="h-full reveal-on-scroll block group" style={{ transitionDelay: '0.1s' }}>
                            <div className="relative h-full bg-white dark:bg-gray-900 rounded-[1.5rem] sm:rounded-[2rem] border border-gray-100 dark:border-gray-800 p-6 sm:p-10 flex flex-col hover:-translate-y-1.5 transition-all duration-500 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] overflow-hidden">
                        ...
                        <Link href="/services/web-development" className="h-full reveal-on-scroll block group" style={{ transitionDelay: '0.15s' }}>
                            <div className="relative h-full bg-white dark:bg-gray-900 rounded-[1.5rem] sm:rounded-[2rem] border border-gray-100 dark:border-gray-800 p-6 sm:p-10 flex flex-col hover:-translate-y-1.5 transition-all duration-500 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] overflow-hidden">
                        ...
                        {/*  Category 4: Branding  */}
                        <Link href="/services/branding-growth" className="h-full reveal-on-scroll block group" style={{ transitionDelay: '0.2s' }}>
                            <div className="relative h-full bg-white dark:bg-gray-900 rounded-[1.5rem] sm:rounded-[2rem] border border-gray-100 dark:border-gray-800 p-6 sm:p-10 flex flex-col hover:-translate-y-1.5 transition-all duration-500 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] overflow-hidden">
                    ...
                    <div className="mt-10 md:mt-14 text-center reveal-on-scroll" style={{ transitionDelay: '0.3s' }}>
                        <Link href="/services" className="inline-flex items-center gap-2 bg-white dark:bg-black text-gray-900 dark:text-white border border-gray-200 dark:border-gray-800 font-bold py-3.5 px-8 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 active:scale-95 group">
                            View All Services
            ...
            <section className="w-full py-8 md:py-12 bg-transparent flex justify-center items-center relative z-20">
                <div className="reveal-on-scroll flex items-center justify-center gap-5 sm:gap-8 px-6">
                    ...
                    <div className="flex items-center">
                        <span className="text-6xl sm:text-7xl md:text-9xl font-black text-transparent bg-clip-text bg-gradient-to-br from-pink-500 to-red-600 counter-value leading-none" data-target="1150">0</span>
                    </div>
                </div>
            </section>
            ...
            <section id="workflow" className="w-full bg-transparent flowing-section flow-top relative z-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 !pt-2 sm:!pt-8">
                    ...
                    <div className="reveal-on-scroll w-full overflow-x-auto no-scrollbar py-6 px-2 sm:px-4 cursor-grab active:cursor-grabbing">
                        <div className="flex items-start justify-between min-w-[800px] lg:min-w-full relative mx-auto">

                            {[
                                { num: 1, label: 'Lead',       title: 'Lead Capture',        desc: 'You submit a project inquiry or book a discovery call.' },
                                { num: 2, label: 'Meet',       title: 'Discovery Call',       desc: 'We discuss your goals, target audience, and finalize the creative scope.' },
                                { num: 3, label: 'Deal',       title: 'Proposal & Contract',  desc: 'We send a tailored proposal, timeline, and secure contract for signing.' },
                                { num: 4, label: 'Advance',    title: 'Advance Payment',      desc: 'The initial deposit is securely processed to lock in your project slot.' },
                                { num: 5, label: 'Onboard',    title: 'Docdril OS Access',    desc: 'You gain portal access to track progress, upload assets, and communicate.' },
                                { num: 6, label: 'Production', title: 'Creative Execution',   desc: 'Our designers, editors, and developers actively build out your solution.' },
                                { num: 7, label: 'Review',     title: 'Client Review',        desc: 'You review drafts directly inside the app and request pin-point revisions.' },
                                { num: 8, label: 'Delivery',   title: 'Delivery',             desc: 'Final assets are delivered. Your project goes live, perfectly packaged.' },
                            ].map((step, idx, arr) => (
                                <div
                                    key={step.num}
                                    className="flex flex-col items-center relative group flex-1 cursor-pointer"
                                    onMouseEnter={() => setHoveredWorkStep(step)}
                                ...
                                >
                                    ...
                                    <span className="mt-4 text-[11px] sm:text-sm font-bold text-gray-500 dark:text-gray-400 transition-colors duration-500 group-hover:text-black dark:text-white dark:group-hover:text-white uppercase tracking-wider">{step.label}</span>
                                </div>
                            ))}
                    ...
                    {/* Info panel — below the track, fixed height so page never jumps */}
                    <div className="min-h-[88px] flex items-center justify-center mt-2 mb-4">
                        <div className={`transition-all duration-300 max-w-sm w-full ${hoveredWorkStep ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-1 pointer-events-none'}`}>
                            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl px-5 py-4 shadow-lg text-center relative mx-4">
                                {/* Arrow pointing UP toward the buttons */}
                                <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-3 h-3 bg-white dark:bg-gray-900 border-t border-l border-gray-200 dark:border-gray-800 rotate-45"></div>
                                <span className="block text-xs sm:text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider mb-1">
                                    {hoveredWorkStep?.title}
                                </span>
                                <p className="text-[11px] sm:text-xs text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                                    {hoveredWorkStep?.desc}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    {/*  Scroll Hint for Mobile  */}
                    <div className="md:hidden text-center text-xs text-gray-400 dark:text-gray-500 mt-1 flex items-center justify-center gap-2">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12 md:mb-20">
                        <h2 className="reveal-on-scroll text-3xl sm:text-4xl md:text-6xl font-extrabold text-gray-900 dark:text-white tracking-tight">
                            Pillars of <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-500">Docdril</span>
                        </h2>
                        <p className="reveal-on-scroll mt-4 text-sm sm:text-lg text-gray-500 dark:text-gray-400 font-medium max-w-2xl mx-auto">The four principles that make every project we touch an exceptional one.</p>
                    </div>
                    ...
                    <div className="reveal-on-scroll flex flex-nowrap overflow-x-auto gap-4 snap-x snap-mandatory pb-8 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-8 md:overflow-visible md:pb-0 no-scrollbar">
                        ...
                        {/*  Step 1  */}
                        <div className="min-w-[75vw] md:min-w-0 snap-center group relative bg-white dark:bg-black/80 backdrop-blur-xl p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-gray-600 shadow-lg hover:shadow-emerald-500/20 transition-all duration-300 hover:-translate-y-2 overflow-hidden h-full">
                            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-400 to-teal-600"></div>
                            <span className="text-7xl font-black text-emerald-100 dark:text-emerald-50/80 absolute -right-2 -top-2 select-none group-hover:text-emerald-200 dark:group-hover:text-emerald-100/80 transition-colors z-0">01</span>
                        ...
                        {/*  Step 2  */}
                        <div className="min-w-[75vw] md:min-w-0 snap-center group relative bg-white dark:bg-black/80 backdrop-blur-xl p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-gray-600 shadow-lg hover:shadow-blue-500/20 transition-all duration-300 hover:-translate-y-2 overflow-hidden h-full">
                            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-400 to-indigo-600"></div>
                            <span className="text-7xl font-black text-blue-100 dark:text-blue-50/80 absolute -right-2 -top-2 select-none group-hover:text-blue-200 dark:group-hover:text-blue-100/80 transition-colors z-0">02</span>
                        ...
                        {/*  Step 3  */}
                        <div className="min-w-[75vw] md:min-w-0 snap-center group relative bg-white dark:bg-black/80 backdrop-blur-xl p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-gray-600 shadow-lg hover:shadow-amber-500/20 transition-all duration-300 hover:-translate-y-2 overflow-hidden h-full">
                            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-amber-400 to-orange-600"></div>
                            <span className="text-7xl font-black text-amber-100 dark:text-amber-50/80 absolute -right-2 -top-2 select-none group-hover:text-amber-200 dark:group-hover:text-amber-100/80 transition-colors z-0">03</span>
                        ...
                        {/*  Step 4  */}
                        <div className="min-w-[75vw] md:min-w-0 snap-center group relative bg-white dark:bg-black/80 backdrop-blur-xl p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-gray-600 shadow-lg hover:shadow-rose-500/20 transition-all duration-300 hover:-translate-y-2 overflow-hidden h-full">
                            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-rose-400 to-red-600"></div>
                            <span className="text-7xl font-black text-rose-100 dark:text-rose-50/80 absolute -right-2 -top-2 select-none group-hover:text-rose-200 dark:group-hover:text-rose-100/80 transition-colors z-0">04</span>
    ...
    {paymentMode === 'new' ? '20%' : '15%'}
        ...
        <svg key={i} className={`w-4 h-4 ${i < 5 ? "text-amber-400" : "text-gray-300 dark:text-gray-600"}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
    ))}</div>
                                ...
                                <div className="w-[340px] sm:w-[380px] shrink-0 relative bg-white/60 dark:bg-white/[0.04] backdrop-blur-xl rounded-2xl border border-gray-200/60 dark:border-white/10 p-6 sm:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.04)] dark:shadow-none">
                                    <div className="flex gap-1 mb-4">{[...Array(5)].map((_, i) => (
        <svg key={i} className={`w-4 h-4 ${i < 4 ? "text-amber-400" : "text-gray-300 dark:text-gray-600"}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
    ))}</div>
        ...
        <svg key={i} className={`w-4 h-4 ${i < 4 ? "text-amber-400" : "text-gray-300 dark:text-gray-600"}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                                ...
                                <div className="w-[340px] sm:w-[380px] shrink-0 relative bg-white/60 dark:bg-white/[0.04] backdrop-blur-xl rounded-2xl border border-gray-200/60 dark:border-white/10 p-6 sm:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.04)] dark:shadow-none">
                                    <div className="flex gap-1 mb-4">{[...Array(5)].map((_, i) => (
        <svg key={i} className={`w-4 h-4 ${i < 3 ? "text-amber-400" : "text-gray-300 dark:text-gray-600"}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
    ))}</div>
