            ...
            <header className="max-w-4xl fade-in" style={{ animationDelay: '0.1s' }}>
                ...
                <div className="prose prose-zinc dark:prose-invert max-w-none mt-12">
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                        Our website uses cookies to enhance your browsing experience, analyze site traffic, and serve tailored content. 
                        Detailed cookie policy terms will be updated here shortly.
                    </p>
                </div>
            </header>
        </main>
