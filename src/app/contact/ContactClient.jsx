...
export default function Contact() {
    ...
    return (
        ...
        <header className="text-center mb-16 md:mb-24 flex flex-col items-center fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            {/* Availability Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/60 dark:bg-zinc-900/60 backdrop-blur-sm border border-zinc-200 dark:border-zinc-700/60 text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-8 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            {/* WhatsApp Card */}
            <Link href="https://wa.me/917304631447" className="group relative flex flex-col p-8 md:p-10 lg:p-12 rounded-[2rem] bg-white/60 dark:bg-zinc-900/40 backdrop-blur-xl border border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:border-zinc-700 hover:bg-white/90 dark:hover:bg-zinc-900/60 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] dark:hover:shadow-[0_20px_40px_-15px_rgba(255,255,255,0.02)] overflow-hidden">
